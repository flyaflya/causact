...
For the current stable release, which is tailored to integrate with `greta` package and uses the soon-to-be-superseded `dag_greta()` function to access sampling, employ the following command:
