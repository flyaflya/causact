...
```{r demoGif, out.width = "45%", echo = FALSE, fig.align = "center"}
...
knitr::include_graphics("chimpStat.png")
```
...
knitr::include_graphics("chimpStatSL.png")
```
...
knitr::include_graphics("eightSchoolStat.png")
```
