...
Using the `causact` package for Bayesian inference is featured in `A Business Analyst's Introduction to Business Analytics` available at http://causact.com/.
...
```{r mixtureGraphGreta, warning = FALSE, message = FALSE}
drawsDF = graph %>% dag_greta()
```
