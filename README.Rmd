...
> The `causact` package offers robust support for both foundational and advanced Bayesian models. While introductory models are well-covered, the utilization of multi-variate distributions such as multi-variate normal, multi-nomial, or dirichlet distributions, along with the implementation of directed acyclic graphs featuring nested or overlapping plates, may present certain challenges. However, ongoing enhancements are in the pipeline to facilitate the construction of these more intricate models.
